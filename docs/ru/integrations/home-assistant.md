...
Настройки уходят прямо на прибор по локальной сети — портал их не хранит. Активной может быть только одна интеграция: включение Home Assistant отключит Bambu Lab или Moonraker, если они были включены.
