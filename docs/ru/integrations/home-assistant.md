...
![Карточки приборов в Home Assistant](../../img/link-ha-card.png)
...
![Окно Home Assistant в блоке «Интеграции» на портале](../../img/link-ha-portal-integration.png)
...
![Приборы iDryer на странице интеграции MQTT](../../img/link-ha-mqtt-devices.png)
...
![Raw configuration editor со вставленной раскладкой](../../img/link-ha-raw-editor.png)
