...
public:
  ...
  uint16_t drying_session_count[NUM_UNITS] = { (uint16_t)0 };
  uint16_t storage_session_count[NUM_UNITS] = { (uint16_t)0 };
  uint16_t profile_session_count[NUM_UNITS] = { (uint16_t)0 };
