...
static const MenuMeta g_menu_meta[MENU_META_COUNT] = {
    ...
    { 16, { "ТЕМПЕРАТУРА", "TEMPERATURE" }, { "°C", "°C" },
      META_VALUE, 15, -1, 0,
      META_VT_U8, 30.0f, 110.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [17] stage_01_ramps
    { 17, { "ПОДЬЕМ", "RAMP" }, { "мин", "min" },
      META_VALUE, 15, -1, 0,
      META_VT_U16, 0.0f, 1200.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [18] stage_01_hold
    ...
    { 186, { "ОБЩИЕ", "GLOBAL" }, { nullptr, nullptr },
      META_SUBMENU, 0, 187, 4,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [187] cmd_ignore_external
    { 187, { "Игнор команд", "Ignor ext cmd" }, { nullptr, nullptr },
      META_TOGGLE, 186, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_GLOBAL },
    // [188] session_count
    { 188, { "СЧЕТЧИК СЕССИЙ", "SESSION COUNTER" }, { nullptr, nullptr },
      META_SUBMENU, 186, 189, 3,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [189] drying_session_count
    { 189, { "СУШКА", "DRYING" }, { nullptr, nullptr },
      META_VALUE, 188, -1, 0,
      META_VT_U16, 0.0f, 65535.0f, 1.0f, META_SCOPE_GLOBAL },
    // [190] storage_session_count
    { 190, { "ХРАНЕНИЕ", "STORAGE" }, { nullptr, nullptr },
      META_VALUE, 188, -1, 0,
      META_VT_U16, 0.0f, 65535.0f, 1.0f, META_SCOPE_GLOBAL },
    // [191] profile_session_count
    { 191, { "ПРОФИЛЬ", "PROFILE" }, { nullptr, nullptr },
      META_VALUE, 188, -1, 0,
      META_VT_U16, 0.0f, 65535.0f, 1.0f, META_SCOPE_GLOBAL },
    // [192] units_count
    { 192, { "КОЛ-ВО ЮНИТОВ", "UNITS" }, { nullptr, nullptr },
      META_VALUE, 186, -1, 0,
      META_VT_U8, 1.0f, 3.0f, 1.0f, META_SCOPE_GLOBAL },
    // [193] language
    { 193, { "ЯЗЫК", "LANGUAGE" }, { nullptr, nullptr },
      META_VALUE, 186, -1, 0,
