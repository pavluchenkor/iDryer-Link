...
static const MenuMeta g_menu_meta[MENU_META_COUNT] = {
    ...
    { 159, { "GAIN", "GAIN" }, { "×", "×" },
      META_VALUE, 155, -1, 0,
      META_VT_F32, 0.1f, 50.0f, 0.01f, META_SCOPE_PER_UNIT },
    ...
    { 165, { "GAIN", "GAIN" }, { "×", "×" },
      META_VALUE, 161, -1, 0,
      META_VT_F32, 0.1f, 200.0f, 0.01f, META_SCOPE_PER_UNIT },
    ...
    { 170, { "ДЕЛЬТА", "DELTA" }, { "°C", "°C" },
      META_VALUE, 167, -1, 0,
      META_VT_U8, 0.0f, 55.0f, 1.0f, META_SCOPE_PER_UNIT },
    ...
    { 197, { "ПОРТ 3", "PORT 3" }, { nullptr, nullptr },
      ...
      META_VT_U8, 0.0f, 3.0f, 1.0f, META_SCOPE_GLOBAL },
    // [198] units_count
    { 198, { "КОЛ-ВО ЮНИТОВ", "UNITS" }, { nullptr, nullptr },
      META_VALUE, 186, -1, 0,
      META_VT_U8, 1.0f, 3.0f, 1.0f, META_SCOPE_GLOBAL },
    // [199] language
    { 199, { "ЯЗЫК", "LANGUAGE" }, { nullptr, nullptr },
      META_VALUE, 186, -1, 0,
