...
static const MenuMeta g_menu_meta[MENU_META_COUNT] = {
    ...
    // [5] dry_start
    { 5, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 2, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [6] storage
    { 6, { "ХРАНЕНИЕ", "STORAGE" }, { NULL, NULL },
      META_SUBMENU, 0, 7, 4,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [7] storage_temp
    ...
    // [15] preset_pla_start
    { 15, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 12, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [16] preset_pla_cf
    { 16, { "PLA-CF", "PLA-CF" }, { NULL, NULL },
    ...
    { 19, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 16, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [20] preset_pla_gf
    { 20, { "PLA-GF", "PLA-GF" }, { NULL, NULL },
    ...
    { 23, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 20, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [24] preset_petg
    { 24, { "PETG", "PETG" }, { NULL, NULL },
    ...
    { 27, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 24, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [28] preset_petg_cf
    { 28, { "PETG-CF", "PETG-CF" }, { NULL, NULL },
    ...
    { 31, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 28, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [32] preset_petg_gf
    { 32, { "PETG-GF", "PETG-GF" }, { NULL, NULL },
    ...
    { 35, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 32, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [36] preset_abs
    { 36, { "ABS", "ABS" }, { NULL, NULL },
    ...
    { 38, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [39] preset_abs_start
    { 39, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 36, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [40] preset_abs_cf
    { 40, { "ABS-CF", "ABS-CF" }, { NULL, NULL },
    ...
    { 43, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 40, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [44] preset_abs_gf
    { 44, { "ABS-GF", "ABS-GF" }, { NULL, NULL },
    ...
    { 50, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [51] preset_pa_start
    { 51, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 48, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [52] preset_pa_cf
    { 52, { "PA-CF", "PA-CF" }, { NULL, NULL },
    ...
    { 55, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 52, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [56] preset_pa_gf
    { 56, { "PA-GF", "PA-GF" }, { NULL, NULL },
    ...
    { 62, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [63] preset_pc_start
    { 63, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 60, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [64] preset_pc_cf
    { 64, { "PC-CF", "PC-CF" }, { NULL, NULL },
    ...
    { 67, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 64, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [68] preset_my1
    { 68, { "MY1", "MY1" }, { NULL, NULL },
    ...
    { 70, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [71] preset_my1_start
    { 71, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 68, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [72] preset_my2
    { 72, { "MY2", "MY2" }, { NULL, NULL },
    ...
    { 74, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [75] preset_my2_start
    { 75, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 72, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [76] preset_my3
    { 76, { "MY3", "MY3" }, { NULL, NULL },
    ...
    { 78, { "ВРЕМЯ", "TIME" }, { "мин", "min" },
      ...
      META_VT_U16, 0.0f, 600.0f, 5.0f, META_SCOPE_GLOBAL },
    // [79] preset_my3_start
    { 79, { "СТАРТ", "START" }, { NULL, NULL },
      META_ACTION, 76, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [80] scales
    { 80, { "ВЕСЫ", "SCALES" }, { NULL, NULL },
      META_SUBMENU, 0, 81, 3,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [81] scales_count
    { 81, { "КОЛ-ВО МОДУЛЕЙ", "NUMBER OF MODULES" }, { NULL, NULL },
      META_VALUE, 80, -1, 0,
      META_VT_U8, 0.0f, 4.0f, 1.0f, META_SCOPE_GLOBAL },
    // [82] tare
    { 82, { "ТАРА", "TARE" }, { NULL, NULL },
    ...
    { 86, { "КАТУШКА 4", "SPOOL 4" }, { "г", "g" },
      ...
      META_VT_F32, 0.0f, 2000.0f, 1.0f, META_SCOPE_GLOBAL },
    // [87] calibration
    { 87, { "КАЛИБРОВКА", "CALIBRATION" }, { NULL, NULL },
      META_SUBMENU, 80, 88, 4,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [88] calib_spool1
    { 88, { "КАТУШКА 1", "SPOOL 1" }, { NULL, NULL },
      META_SUBMENU, 87, 89, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [89] calib_zero1
    { 89, { "ПРИНЯТЬ НОЛЬ", "SET ZERO" }, { NULL, NULL },
      META_ACTION, 88, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [90] calib_kg_1
    { 90, { "ПРИНЯТЬ 1000 Г", "SET 1000 G" }, { NULL, NULL },
      META_ACTION, 88, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [91] calib_spool2
    { 91, { "КАТУШКА 2", "SPOOL 2" }, { NULL, NULL },
      META_SUBMENU, 87, 92, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [92] calib_zero2
    { 92, { "ПРИНЯТЬ НОЛЬ", "SET ZERO" }, { NULL, NULL },
      META_ACTION, 91, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [93] calib_kg_2
    { 93, { "ПРИНЯТЬ 1000 Г", "SET 1000 G" }, { NULL, NULL },
      META_ACTION, 91, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [94] calib_spool3
    { 94, { "КАТУШКА 3", "SPOOL 3" }, { NULL, NULL },
      META_SUBMENU, 87, 95, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [95] calib_zero3
    { 95, { "ПРИНЯТЬ НОЛЬ", "SET ZERO" }, { NULL, NULL },
      META_ACTION, 94, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [96] calib_kg_3
    { 96, { "ПРИНЯТЬ 1000 Г", "SET 1000 G" }, { NULL, NULL },
      META_ACTION, 94, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [97] calib_spool4
    { 97, { "КАТУШКА 4", "SPOOL 4" }, { NULL, NULL },
      META_SUBMENU, 87, 98, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [98] calib_zero4
    { 98, { "ПРИНЯТЬ НОЛЬ", "SET ZERO" }, { NULL, NULL },
      META_ACTION, 97, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [99] calib_kg_4
    { 99, { "ПРИНЯТЬ 1000 Г", "SET 1000 G" }, { NULL, NULL },
      META_ACTION, 97, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_GLOBAL },
    // [100] settings
    { 100, { "НАСТРОЙКИ", "SETTINGS" }, { NULL, NULL },
      META_SUBMENU, 0, 101, 6,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [101] storage_logic
    { 101, { "ХРАНЕНИЕ", "STORAGE" }, { NULL, NULL },
      META_SUBMENU, 100, 102, 5,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [102] storage_auto
    { 102, { "АВТО ХРАНЕНИЕ", "AUTO STORAGE" }, { NULL, NULL },
      META_TOGGLE, 101, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [103] storage_auto_dry
    { 103, { "АВТО СУШКА", "AUTO DRY" }, { NULL, NULL },
      META_TOGGLE, 101, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [104] storage_rh
    { 104, { "ПО ВЛАЖНОСТИ", "BY HUMID" }, { NULL, NULL },
    ...
    { 106, { "ПО ТЕМПЕРАТУРЕ", "BY TEMP" }, { NULL, NULL },
      META_SUBMENU, 101, 107, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [107] storage_dry_temp_mode
    { 107, { "АБС/%СУШКИ", "ABS/%DRY" }, { NULL, NULL },
      META_TOGGLE, 106, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_PER_UNIT },
    ...
    // [111] PID_heater
    { 111, { "ПИД НАГРЕВАТЕЛЬ", "PID HEATER" }, { NULL, NULL },
    ...
    { 116, { "Автопид", "Autopid" }, { NULL, NULL },
      META_ACTION, 111, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [117] PID_chamber
    { 117, { "ПИД ВОЗДУХ", "PID CHAMBER" }, { NULL, NULL },
    ...
    { 122, { "Автопид", "Autopid" }, { NULL, NULL },
      META_ACTION, 117, -1, 0,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [123] heating
    { 123, { "НАГРЕВ", "HEATING" }, { NULL, NULL },
    ...
    { 127, { "ДЕЛЬТА АБС/%", "DELTA ABS/%" }, { NULL, NULL },
      META_TOGGLE, 123, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [128] heating_check
    { 128, { "ПРОВЕРКА", "CHECK" }, { NULL, NULL },
      META_SUBMENU, 123, 129, 4,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [129] vh_max_err
    { 129, { "ПОРОГ ОШИБКИ", "ERROR LIMIT" }, { NULL, NULL },
      META_VALUE, 128, -1, 0,
    ...
    { 141, { "УМНЫЙ РЕЖИМ", "SMART MODE" }, { NULL, NULL },
      META_TOGGLE, 136, -1, 0,
      META_VT_BOOL, 0.0f, 0.0f, 1.0f, META_SCOPE_PER_UNIT },
    // [142] global_settings
    { 142, { "ОБЩИЕ", "GLOBAL" }, { NULL, NULL },
      META_SUBMENU, 0, 143, 2,
      META_VT_F32, 0.0f, 0.0f, 0.0f, META_SCOPE_PER_UNIT },
    // [143] units_count
    { 143, { "КОЛ-ВО ЮНИТОВ", "UNITS" }, { NULL, NULL },
      META_VALUE, 142, -1, 0,
      META_VT_U8, 1.0f, 3.0f, 1.0f, META_SCOPE_GLOBAL },
    // [144] language
    { 144, { "ЯЗЫК", "LANGUAGE" }, { NULL, NULL },
      META_VALUE, 142, -1, 0,
