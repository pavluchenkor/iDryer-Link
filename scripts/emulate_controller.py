#!/usr/bin/env python3
"""
Эмулятор RP2040 для UART-протокола iDryer.

Посылает Hello, Telemetry, Status, Weights, Rfid, Heartbeat.
Отвечает на HelloRequest, Command, ConfigPush.

Протокол: docs/02-uart/02-binary-format.md
